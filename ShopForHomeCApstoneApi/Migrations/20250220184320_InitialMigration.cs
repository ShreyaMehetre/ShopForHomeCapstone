...
namespace ShopForHomeCApstoneApi.Migrations
{
    ...
    public partial class InitialMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "ProductId", "CategoryId", "Description", "ImageUrl", "Price", "ProductName", "Rating", "StockQuantity" },
                values: new object[,]
                {
                    { 1, 1, "Solid wood dining table with modern design.", "https://example.com/dining-table.jpg", 15000m, "Wooden Dining Table", 4.5, 20 },
                    { 2, 2, "Elegant wall mirror for home décor.", "https://example.com/wall-mirror.jpg", 3500m, "Decorative Wall Mirror", 4.2000000000000002, 30 },
                    { 3, 3, "Energy-efficient LED ceiling light.", "https://example.com/led-light.jpg", 2200m, "LED Ceiling Light", 4.7999999999999998, 50 }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DiscountCoupons_CouponId",
